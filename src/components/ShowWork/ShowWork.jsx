export default function ShowWork(props) {
    ...
    return (
        <div className="relative cursor-pointer rounded-lg max-h-[512px] overflow-hidden">
            <a href={link} target="_blank">
                <img 
                    src={img} 
                    alt="thumbnail" 
                    className="block w-auto h-full transition-filter duration-300 ease-in-out hover:filter hover:brightness-50"
                />
